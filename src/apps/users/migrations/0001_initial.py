    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='apartments.city', verbose_name='users')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='apartments.country', verbose_name='users')),
